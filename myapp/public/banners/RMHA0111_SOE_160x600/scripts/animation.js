...
function initAnimation() {
	...
	.from(glogo, 0.4, {autoAlpha:0,  ease: Power2.easeOut}, 'f1+=0.6')
	.to(glogo, 0.4, {autoAlpha:0,  ease: Power2.easeOut}, 'f2')
	...
	.from(tcs, 0.5, {autoAlpha:0, ease: Power1.easeInOut}, 'f5+=0.5')
